...
public interface ExperimentReportMapper {
    ...
    List<StudentExperimentReport> findExperimentReportAll(@Param("course_id")String course_id, @Param("status")int status, @Param("isCorrect")int isCorrect, @Param("name")String name, @Param("startTime")String startTime, @Param("endTime")String endTime);
}
