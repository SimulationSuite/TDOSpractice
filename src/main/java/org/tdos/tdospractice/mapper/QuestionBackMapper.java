...
public interface QuestionBackMapper {
    ...
    List<QuestionBackEntity> getQuestionBackAll(@Param("type") Integer type, @Param("categoryId") String categoryId, @Param("cCategoryId") String cCategoryId, @Param("content") String content, @Param("assignmentId") String assignmentId);
